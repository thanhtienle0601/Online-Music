...
class PlayAlbum extends StatefulWidget {
  final String? title_album;
  final String? img;
  final String? id;
  const PlayAlbum({super.key,this.title_album,this.img,this.id});

  @override
  State<PlayAlbum> createState() => PlayAlbumState();
}

class PlayAlbumState extends State<PlayAlbum> {
  SongAPI? songAPI;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(utf8.decode(widget.title_album!.codeUnits).toUpperCase()),
