...
public class PlaylistSongDto2 {
	...
	public PlaylistSongDto2() {
		super();
	}

	public PlaylistSongDto2(Integer id, Integer playlist_id, String playlist_name, Integer song_id, String title,
